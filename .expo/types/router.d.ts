...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/config` | `/config` | `/(tabs)/contato` | `/contato` | `/(tabs)/` | `/(tabs)` | `/(tabs)/vacinacao` | `/vacinacao` | `/context/AuthContext` | `/funLogin/cadastrarPet` | `/funLogin/cadastro` | `/funLogin/conta` | `/funLogin/editar_perfil` | `/funLogin/modal` | `/login`;
  // prettier-ignore
