    ...
    <ImageBackground source={backgroundImage} style={styles.background} resizeMode="cover">
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.container}>
            ...
            <View style={styles.header}>
              ...
              <Text style={styles.welcome}>A melhor segurança do seu Pet! </Text>
            </View>

            <View style={styles.content}>
              {/* <Text style={styles.loginTitle}> Logar na conta </Text> */}
              ...
              <View style={styles.passwordContainer}>
                ...
                <TouchableOpacity onPress={() => setMostrarSenha(!mostrarSenha)} style={styles.icon}>
                  <Ionicons name={mostrarSenha ? 'eye-off' : 'eye'} size={ 35 } color="#fff" />
                </TouchableOpacity>
              </View>
              ...
              <View style={styles.signUpTextContainer}>
                <Text style={styles.signUpText}>
                  Não tem conta?
                  <Text style={styles.linkText} onPress={() => router.push('/funLogin/cadastro')}> Cadastre-se </Text>
                </Text>
              </View>

              <View style={styles.versao}>
                <Text style={styles.versaoText}> 0.0.3 </Text>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  versao: {
    backgroundColor: 'rgba(98, 98, 98, 0.81)',
